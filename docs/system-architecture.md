...
```mermaid
flowchart TD
    A[사용자] --> B[src/main.py<br/>프로그램 시작점]
...
1. 사용자가 프로젝트 루트에서 `python src/main.py`를 실행합니다.
2. `src/main.py`가 `QuizGame` 객체를 만듭니다.
...
- `src/main.py`는 시작만 담당하게 해서 가장 단순하게 유지했습니다.
